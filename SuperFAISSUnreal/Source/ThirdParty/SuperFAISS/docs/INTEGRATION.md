...
bytes/row sub-norm arena. The scratch concurrency contract is unchanged — single writer,
lock-free snapshot readers, exclusive `Grow`/`Freeze`/`Load` (§3, and DETERMINISM.md §2b).
